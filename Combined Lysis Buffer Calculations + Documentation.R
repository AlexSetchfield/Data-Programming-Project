...
#'
#' Calculates the mass (g) required for constituents of lysis buffer (required for sonication), based on concentrations (mM), molecular weights (Mr) and final volume required (ml).
#'
#' @param TrisHCl.conc
...
#' volume <- 1000
#'
#' masscalc(TrisHcl.conc, NaCl.conc, DTT.conc, PMSF.conc)
#'
#' @export
masscalc <- function(TrisHCl.conc, NaCl.conc, DTT.conc, PMSF.conc) {
