...
#' volume <- 1000
#'
#' lbmasscalc(TrisHCl.conc, NaCl.conc, DTT.conc, PMSF.conc, volume)
#'
#' lbmasscalc(TrisHCl.conc = 50, NaCl.con = 200, DTT.conc = 5, PMSF.conc = 1, volume = 1000)
#' 
#' @export
lbmasscalc <- function(TrisHCl.conc, NaCl.conc, DTT.conc, PMSF.conc, volume) {
